...
WORDS = {
    ...
    "de": {
        ...
        "sections": [
            ...
            ["Kosten und Budget", [
                ...
                "Die Hardware wurde einmal ersetzt, der Support blieb \u00fcber das Quartal stabil.",
                "Zwei Server sind ohne Ausfalltag zum neuen Anbieter umgezogen.",]],
            ["N\xe4chstes Quartal", [
            ...
            ["Die Menschen", [
                ...
                "Die Urlaubsvertretung wurde im April geregelt und trug durch den Sommer.",
                "Alle haben die Schulung absolviert, die die neue Lizenz verlangt.",
            ]],
            ["Risiken", [
                "Der Umzug im November ist der einzige Termin, an dem nichts vorbeigeht.",
                "Ein Lieferant hat die neuen Bedingungen noch nicht unterschrieben.",
                "Die Hostingkosten steigen im Januar, wenn der Vertrag nicht fr\xfcher erneuert wird.",
            ]],
        ],
        ...
        "total": "Gesamt",
        "periods": ["Q1", "Q2", "Q3", "Q4"],
        "rows": ["Software", "Reisen", "Hardware", "Marketing", "Support", "Schulung", "Lizenzen", "Hosting", "Veranstaltungen", "B\u00fcro", "Cloud", "Personalsuche", "Recht", "Versicherung", "Verpflegung", "Versand", "Werbung", "Beratung", "Wartung", "Nebenkosten"],
        "slides": [
    ...
    "es": {
        ...
        "sections": [
            ...
            ["Costes y presupuesto", [
                ...
                "Dos servidores pasaron al nuevo proveedor sin un d\xeda de ca\xedda.",]],
            ...
            ["Riesgos", [
                ...
                "Un proveedor a\xfan no ha firmado las nuevas condiciones.",
        ...
        "total": "Total",
        "periods": ["T1", "T2", "T3", "T4"],
        "rows": ["Software", "Viajes", "Hardware", "Marketing", "Soporte", "Formaci\u00f3n", "Licencias", "Alojamiento", "Eventos", "Oficina", "Nube", "Contrataci\xf3n", "Legal", "Seguros", "Catering", "Env\xedos", "Publicidad", "Consultor\xeda", "Mantenimiento", "Suministros"],
        "slides": [
    ...
    "fr": {
        ...
        "sections": [
            ["Points forts", [
                "Les co\u00fbts sont rest\u00e9s sous le budget et deux nouveaux partenaires ont rejoint le projet.",
            ...
            ["Co\u00fbts et budget", [
                "Les d\u00e9penses de logiciels ont augment\u00e9 avec les nouvelles licences, tandis que les voyages ont encore baiss\u00e9.",
                "Le mat\u00e9riel a \u00e9t\u00e9 remplac\u00e9 une fois et le support est rest\u00e9 stable sur le trimestre.",
                "Deux serveurs ont migr\xe9 vers le nouveau prestataire sans une journ\xe9e d'arr\xeat.",]],
            ["Trimestre prochain", [
            ...
            ["Les personnes", [
                ...
                "Les remplacements d'\xe9t\xe9 ont \xe9t\xe9 organis\xe9s en avril et ont tenu.",
            ...
            ["Risques", [
                ...
                "L'h\xe9bergement augmente en janvier sans renouvellement anticip\xe9.",
            ]],
        ],
        ...
        "total": "Total",
        "periods": ["T1", "T2", "T3", "T4"],
        "rows": ["Logiciels", "Voyages", "Mat\u00e9riel", "Marketing", "Support", "Formation", "Licences", "H\u00e9bergement", "\u00c9v\u00e9nements", "Bureau", "Cloud", "Recrutement", "Juridique", "Assurance", "Traiteur", "Exp\xe9dition", "Publicit\xe9", "Conseil", "Maintenance", "Charges"],
        "slides": [
    ...
    "it": {
        ...
        "sections": [
            ["In evidenza", [
                ...
                "La nuova versione ha raggiunto pi\u00f9 persone in una settimana di quante la precedente in un mese.",
                "Il supporto ha risposto a nove richieste su dieci in giornata.",]],
            ["Costi e budget", [
                "La spesa per il software \u00e8 cresciuta con le nuove licenze, mentre i viaggi sono di nuovo calati.",
            ...
            ["Rischi", [
                ...
                "L'hosting aumenta a gennaio se il contratto non si rinnova prima.",
            ]],
        ],
        ...
        "total": "Totale",
        "periods": ["T1", "T2", "T3", "T4"],
        "rows": ["Software", "Viaggi", "Hardware", "Marketing", "Supporto", "Formazione", "Licenze", "Hosting", "Eventi", "Ufficio", "Cloud", "Selezione", "Legale", "Assicurazione", "Catering", "Spedizioni", "Pubblicit\xe0", "Consulenza", "Manutenzione", "Utenze"],
        "slides": [
    ...
    "pl": {
        ...
        "sections": [
            ...
            ["Koszty i bud\u017cet", [
                ...
                "Dwa serwery przeniesiono do nowego dostawcy bez dnia przestoju.",]],
            ["Nast\u0119pny kwarta\u0142", [
            ...
            ["Ludzie", [
                "Nad wersj\u0105 pracowa\u0142o sze\u015b\u0107 os\xf3b, dwie z nich do\u0142\u0105czy\u0142y w tym roku.",
                "Zast\u0119pstwa urlopowe ustalono w kwietniu i wytrzyma\u0142y ca\u0142e lato.",
            ...
            ["Ryzyka", [
                ...
                "Jeden dostawca nie podpisa\u0142 jeszcze nowych warunk\xf3w.",
                "Koszty hostingu rosn\u0105 w styczniu, je\u015bli umowa nie zostanie odnowiona wcze\u015bniej.",
            ]],
        ],
        ...
        "item": "Pozycja",
        "total": "Razem",
        "periods": ["I kw.", "II kw.", "III kw.", "IV kw."],
        "rows": ["Oprogramowanie", "Podr\u00f3\u017ce", "Sprz\u0119t", "Marketing", "Wsparcie", "Szkolenia", "Licencje", "Hosting", "Wydarzenia", "Biuro", "Chmura", "Rekrutacja", "Prawo", "Ubezpieczenie", "Catering", "Wysy\u0142ka", "Reklama", "Doradztwo", "Utrzymanie", "Media"],
        "slides": [
    ...
    "pt-BR": {
        ...
        "sections": [
            ...
            ["As pessoas", [
                ...
                "A cobertura de f\xe9rias foi combinada em abril e durou o ver\xe3o todo.",
        ...
        "total": "Total",
        "periods": ["T1", "T2", "T3", "T4"],
        "rows": ["Software", "Viagens", "Hardware", "Marketing", "Suporte", "Treinamento", "Licen\u00e7as", "Hospedagem", "Eventos", "Escrit\u00f3rio", "Nuvem", "Recrutamento", "Jur\xeddico", "Seguros", "Buffet", "Frete", "Publicidade", "Consultoria", "Manuten\xe7\xe3o", "Utilidades"],
        "slides": [
    ...
    "ru": {
        ...
        "lead": "\u041a\u043e\u043c\u0430\u043d\u0434\u0430 \u0432\u044b\u043f\u043e\u043b\u043d\u0438\u043b\u0430 \u0432\u0441\u0435 \u0446\u0435\u043b\u0438 \u0432\u0442\u043e\u0440\u043e\u0433\u043e \u043a\u0432\u0430\u0440\u0442\u0430\u043b\u0430, \u0438 \u043d\u043e\u0432\u0430\u044f \u0432\u0435\u0440\u0441\u0438\u044f \u0432\u044b\u0448\u043b\u0430 \u0432 \u0441\u0440\u043e\u043a.",
        "sections": [
            ["\u0413\u043b\u0430\u0432\u043d\u043e\u0435", [
            ...
            ["\u0420\u0430\u0441\u0445\u043e\u0434\u044b \u0438 \u0431\u044e\u0434\u0436\u0435\u0442", [
                "\u0417\u0430\u0442\u0440\u0430\u0442\u044b \u043d\u0430 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u044b \u0432\u044b\u0440\u043e\u0441\u043b\u0438 \u0438\u0437-\u0437\u0430 \u043d\u043e\u0432\u044b\u0445 \u043b\u0438\u0446\u0435\u043d\u0437\u0438\u0439, \u0430 \u0440\u0430\u0441\u0445\u043e\u0434\u044b \u043d\u0430 \u043f\u043e\u0435\u0437\u0434\u043a\u0438 \u0441\u043d\u043e\u0432\u0430 \u0441\u043d\u0438\u0437\u0438\u043b\u0438\u0441\u044c.",
            ...
            ["\u041b\u044e\u0434\u0438", [
                ...
                "\u0417\u0430\u043c\u0435\u043d\u044b \u043d\u0430 \u0432\u0440\u0435\u043c\u044f \u043e\u0442\u043f\u0443\u0441\u043a\u043e\u0432 \u0441\u043e\u0433\u043b\u0430\u0441\u043e\u0432\u0430\u043b\u0438 \u0432 \u0430\u043f\u0440\u0435\u043b\u0435, \u0438 \u043b\u0435\u0442\u043e\u043c \u0432\u0441\u0451 \u0441\u043e\u0448\u043b\u043e\u0441\u044c.",
                "\u0412\u0441\u0435 \u043f\u0440\u043e\u0448\u043b\u0438 \u043e\u0431\u0443\u0447\u0435\u043d\u0438\u0435, \u043a\u043e\u0442\u043e\u0440\u043e\u0433\u043e \u0442\u0440\u0435\u0431\u0443\u0435\u0442 \u043d\u043e\u0432\u0430\u044f \u043b\u0438\u0446\u0435\u043d\u0437\u0438\u044f.",
            ]],
            ["\u0420\u0438\u0441\u043a\u0438", [
                "\u041f\u0435\u0440\u0435\u0435\u0437\u0434 \u0432 \u043d\u043e\u044f\u0431\u0440\u0435 \u2014 \u0435\u0434\u0438\u043d\u0441\u0442\u0432\u0435\u043d\u043d\u0430\u044f \u0434\u0430\u0442\u0430, \u043a\u043e\u0442\u043e\u0440\u0443\u044e \u043d\u0435\u043b\u044c\u0437\u044f \u0441\u0434\u0432\u0438\u043d\u0443\u0442\u044c.",
                "\u041e\u0434\u0438\u043d \u043f\u043e\u0441\u0442\u0430\u0432\u0449\u0438\u043a \u0442\u0430\u043a \u0438 \u043d\u0435 \u043f\u043e\u0434\u043f\u0438\u0441\u0430\u043b \u043d\u043e\u0432\u044b\u0435 \u0443\u0441\u043b\u043e\u0432\u0438\u044f.",
        ...
        "item": "\u0421\u0442\u0430\u0442\u044c\u044f",
        "total": "\u0418\u0442\u043e\u0433\u043e",
        "periods": ["I \u043a\u0432.", "II \u043a\u0432.", "III \u043a\u0432.", "IV \u043a\u0432."],
        "rows": ["\u041f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u044b", "\u041f\u043e\u0435\u0437\u0434\u043a\u0438", "\u041e\u0431\u043e\u0440\u0443\u0434\u043e\u0432\u0430\u043d\u0438\u0435", "\u041c\u0430\u0440\u043a\u0435\u0442\u0438\u043d\u0433", "\u041f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0430", "\u041e\u0431\u0443\u0447\u0435\u043d\u0438\u0435", "\u041b\u0438\u0446\u0435\u043d\u0437\u0438\u0438", "\u0425\u043e\u0441\u0442\u0438\u043d\u0433", "\u041c\u0435\u0440\u043e\u043f\u0440\u0438\u044f\u0442\u0438\u044f", "\u041e\u0444\u0438\u0441", "\u041e\u0431\u043b\u0430\u043a\u043e", "\u041d\u0430\u0439\u043c", "\u042e\u0440\u0438\u0441\u0442\u044b", "\u0421\u0442\u0440\u0430\u0445\u043e\u0432\u0430\u043d\u0438\u0435", "\u041a\u0435\u0439\u0442\u0435\u0440\u0438\u043d\u0433", "\u0414\u043e\u0441\u0442\u0430\u0432\u043a\u0430", "\u0420\u0435\u043a\u043b\u0430\u043c\u0430", "\u041a\u043e\u043d\u0441\u0430\u043b\u0442\u0438\u043d\u0433", "\u041e\u0431\u0441\u043b\u0443\u0436\u0438\u0432\u0430\u043d\u0438\u0435", "\u041a\u043e\u043c\u043c\u0443\u043d\u0430\u043b\u044c\u043d\u044b\u0435"],
        "slides": [
    ...
    "tr": {
        ...
        "sections": [
            ...
            ["Ekip", [
                ...
                "\u0130zin d\xf6nemi vekaletleri nisanda ayarland\u0131 ve yaz boyunca y\xfcr\xfcd\xfc.",
                "Herkes yeni lisans\u0131n gerektirdi\u011fi e\u011fitimi tamamlad\u0131.",
            ]],
            ["Riskler", [
                "Kas\u0131mdaki ta\u015f\u0131nma, kayamayacak tek tarih.",
                "Bir tedarik\xe7i yeni ko\u015fullar\u0131 hen\xfcz imzalamad\u0131.",
                "S\xf6zle\u015fme erken yenilenmezse bar\u0131nd\u0131rma maliyeti ocakta art\u0131yor.",
            ]],
        ],
        ...
        "item": "Kalem",
        "total": "Toplam",
        "periods": ["1. \u00c7", "2. \u00c7", "3. \u00c7", "4. \u00c7"],
        "rows": ["Yaz\u0131l\u0131m", "Seyahat", "Donan\u0131m", "Pazarlama", "Destek", "E\u011fitim", "Lisanslar", "Bar\u0131nd\u0131rma", "Etkinlikler", "Ofis", "Bulut", "\u0130\u015fe al\u0131m", "Hukuk", "Sigorta", "\u0130kram", "Kargo", "Reklam", "Dan\u0131\u015fmanl\u0131k", "Bak\u0131m", "Faturalar"],
        "slides": [
...
FILE_NAMES = {
    ...
    "es": {"text": "Informe trimestral", "sheet": "Presupuesto", "slides": "Plan del proyecto",
           "word": "Contrato", "cells": "Cifras de ventas", "deck": "Reuni\u00f3n de equipo",
           "paper": "Factura", "rows": "Contactos", "notes": "Notas"},
    "fr": {"text": "Rapport trimestriel", "sheet": "Budget", "slides": "Plan du projet",
           "word": "Contrat", "cells": "Chiffres de ventes", "deck": "R\u00e9union d'\u00e9quipe",
           "paper": "Facture", "rows": "Contacts", "notes": "Notes"},
    "it": {"text": "Relazione trimestrale", "sheet": "Bilancio", "slides": "Piano di progetto",
           "word": "Contratto", "cells": "Dati di vendita", "deck": "Riunione del team",
    ...
    "tr": {"text": "\u00dc\u00e7 ayl\u0131k rapor", "sheet": "B\u00fct\u00e7e", "slides": "Proje plan\u0131",
           "word": "S\u00f6zle\u015fme", "cells": "Sat\u0131\u015f rakamlar\u0131", "deck": "Ekip toplant\u0131s\u0131",
...
FILLER_NAMES = {
    ...
    "es": {
        ...
        "kickoff": "Inicio", "course": "Diapositivas del curso",
        "lease": "Contrato de alquiler", "resume": "Curr\u00edculum", "application": "Solicitud",
    ...
    "fr": {
        ...
        "travel": "Plan de voyage", "reading": "Liste de lecture",
    ...
    "pt-BR": {
        ...
        "kickoff": "In\u00edcio", "course": "Slides do curso",
    ...
    "tr": {
        ...
        "stocktake": "Say\u0131m",
        "kickoff": "Ba\u015flang\u0131\u00e7", "course": "Kurs slaytlar\u0131",
...
OTHERS = {
    ...
    "de": {
        ...
        "contacts": [["Name", "Rolle", "E-Mail", "Telefon"],
    ...
    "es": {
        ...
        "contacts": [["Nombre", "Puesto", "Correo", "Tel\u00e9fono"],
    ...
    "fr": {
        "contract": ["Contrat de service",
                     ...
                     ["Le prestataire fournit le logiciel d\u00e9crit en annexe pendant un an.",
                      ...
                      "Aucune partie ne peut c\xe9der ce contrat \xe0 un tiers sans accord.",
                      "L'annexe indique le logiciel couvert et la version \xe0 partir de laquelle il s'applique.",
        ...
        "contacts": [["Nom", "R\u00f4le", "E-mail", "T\u00e9l\u00e9phone"],
    ...
    "it": {
        "contract": ["Contratto di servizio",
                     ...
                     ["Il fornitore mette a disposizione per un anno il software descritto in allegato.",
                      ...
                      "L'allegato elenca il software coperto e la versione da cui decorre.",
                      "Il presente contratto sostituisce ogni accordo precedente tra le parti."]],
        "invoice": ["Fattura 2026-014", "Emessa il 12 giugno 2026", "Da saldare entro 30 giorni", "Fatturato a", "Subtotale", "IVA 20%", "Importo dovuto", "Grazie per la collaborazione.", "Qt\xe0", "Prezzo unit."],
        "contacts": [["Nome", "Ruolo", "E-mail", "Telefono"],
    ...
    "pl": {
        "contract": ["Umowa o \u015bwiadczenie us\u0142ug",
                     ...
                     ["Dostawca udost\u0119pnia oprogramowanie opisane w za\u0142\u0105czniku na okres roku.",
                      "P\u0142atno\u015b\u0107 jest wymagana w ci\u0105gu trzydziestu dni od ka\u017cdej faktury.",
                      ...
                      "Obie strony traktuj\u0105 jako poufne to, czego dowiedz\u0105 si\u0119 o sobie.",
                      ...
                      "Za\u0142\u0105cznik wymienia obj\u0119te oprogramowanie i wersj\u0119, od kt\xf3rej obowi\u0105zuje.",
                      "Niniejsza umowa zast\u0119puje wszystkie wcze\u015bniejsze ustalenia stron."]],
        "invoice": ["Faktura 2026-014", "Wystawiono 12 czerwca 2026", "P\u0142atne w ci\u0105gu 30 dni", "Nabywca", "Suma cz\u0119\u015bciowa", "VAT 20%", "Do zap\u0142aty", "Dzi\u0119kujemy za wsp\xf3\u0142prac\u0119.", "Ilo\u015b\u0107", "Cena jedn."],
        "contacts": [["Imi\u0119", "Rola", "E-mail", "Telefon"],
                     ["Design", "Wsparcie", "Sprzeda\u017c", "Rozw\u00f3j"]],
    },
    "pt-BR": {
        "contract": ["Contrato de servi\u00e7o",
                     ...
                     ["O fornecedor disponibiliza por um ano o software descrito no anexo.",
                      ...
                      "Qualquer parte pode encerrar o contrato com tr\u00eas meses de aviso.",
                      ...
                      "Os pre\xe7os valem no primeiro ano e s\xe3o revistos a cada outono.",
                      "Nenhuma parte pode transferir este contrato a terceiros sem consentimento.",
                      "O anexo lista o software abrangido e a vers\xe3o a partir da qual vale.",
                      "Este contrato substitui qualquer acordo anterior entre as partes."]],
        "invoice": ["Fatura 2026-014", "Emitida em 12 de junho de 2026", "Vence em 30 dias", "Faturado para", "Subtotal", "IVA 20%", "Valor a pagar", "Obrigado pela prefer\xeancia.", "Qtd", "Pre\xe7o unit."],
        "contacts": [["Nome", "Fun\u00e7\u00e3o", "E-mail", "Telefone"],
    ...
    "ru": {
        "contract": ["\u0414\u043e\u0433\u043e\u0432\u043e\u0440 \u043e\u043a\u0430\u0437\u0430\u043d\u0438\u044f \u0443\u0441\u043b\u0443\u0433",
                     ...
                     ["\u0418\u0441\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c \u043f\u0440\u0435\u0434\u043e\u0441\u0442\u0430\u0432\u043b\u044f\u0435\u0442 \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u043d\u043e\u0435 \u043e\u0431\u0435\u0441\u043f\u0435\u0447\u0435\u043d\u0438\u0435 \u0438\u0437 \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u044f \u043d\u0430 \u043e\u0434\u0438\u043d \u0433\u043e\u0434.",
                      ...
                      "\u0417\u0430\u043a\u0430\u0437\u0447\u0438\u043a \u043d\u0430\u0437\u043d\u0430\u0447\u0430\u0435\u0442 \u043e\u0434\u043d\u043e\u0433\u043e \u0447\u0435\u043b\u043e\u0432\u0435\u043a\u0430, \u0443\u0442\u0432\u0435\u0440\u0436\u0434\u0430\u044e\u0449\u0435\u0433\u043e \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f.",
                      "\u0426\u0435\u043d\u044b \u0434\u0435\u0440\u0436\u0430\u0442\u0441\u044f \u043f\u0435\u0440\u0432\u044b\u0439 \u0433\u043e\u0434 \u0438 \u043f\u0435\u0440\u0435\u0441\u043c\u0430\u0442\u0440\u0438\u0432\u0430\u044e\u0442\u0441\u044f \u043a\u0430\u0436\u0434\u0443\u044e \u043e\u0441\u0435\u043d\u044c.",
                      "\u041d\u0438 \u043e\u0434\u043d\u0430 \u0438\u0437 \u0441\u0442\u043e\u0440\u043e\u043d \u043d\u0435 \u0432\u043f\u0440\u0430\u0432\u0435 \u043f\u0435\u0440\u0435\u0434\u0430\u0442\u044c \u0434\u043e\u0433\u043e\u0432\u043e\u0440 \u0442\u0440\u0435\u0442\u044c\u0435\u043c\u0443 \u043b\u0438\u0446\u0443 \u0431\u0435\u0437 \u0441\u043e\u0433\u043b\u0430\u0441\u0438\u044f.",
                      "\u0412 \u043f\u0440\u0438\u043b\u043e\u0436\u0435\u043d\u0438\u0438 \u043f\u0435\u0440\u0435\u0447\u0438\u0441\u043b\u0435\u043d\u043e \u043f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u043d\u043e\u0435 \u043e\u0431\u0435\u0441\u043f\u0435\u0447\u0435\u043d\u0438\u0435 \u0438 \u0432\u0435\u0440\u0441\u0438\u044f, \u0441 \u043a\u043e\u0442\u043e\u0440\u043e\u0439 \u043e\u043d\u043e \u0434\u0435\u0439\u0441\u0442\u0432\u0443\u0435\u0442.",
                      "\u041d\u0430\u0441\u0442\u043e\u044f\u0449\u0438\u0439 \u0434\u043e\u0433\u043e\u0432\u043e\u0440 \u0437\u0430\u043c\u0435\u043d\u044f\u0435\u0442 \u0432\u0441\u0435 \u043f\u0440\u0435\u0436\u043d\u0438\u0435 \u0434\u043e\u0433\u043e\u0432\u043e\u0440\u0451\u043d\u043d\u043e\u0441\u0442\u0438 \u0441\u0442\u043e\u0440\u043e\u043d."]],
        "invoice": ["\u0421\u0447\u0451\u0442 2026-014", "\u0412\u044b\u0441\u0442\u0430\u0432\u043b\u0435\u043d 12 \u0438\u044e\u043d\u044f 2026", "\u041e\u043f\u043b\u0430\u0442\u0430 \u0432 \u0442\u0435\u0447\u0435\u043d\u0438\u0435 30 \u0434\u043d\u0435\u0439", "\u041f\u043b\u0430\u0442\u0435\u043b\u044c\u0449\u0438\u043a", "\u041f\u0440\u043e\u043c\u0435\u0436\u0443\u0442\u043e\u0447\u043d\u044b\u0439 \u0438\u0442\u043e\u0433", "\u041d\u0414\u0421 20%", "\u041a \u043e\u043f\u043b\u0430\u0442\u0435", "\u0411\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u0438\u043c \u0437\u0430 \u0441\u043e\u0442\u0440\u0443\u0434\u043d\u0438\u0447\u0435\u0441\u0442\u0432\u043e.", "\u041a\u043e\u043b-\u0432\u043e", "\u0426\u0435\u043d\u0430 \u0437\u0430 \u0435\u0434."],
        "contacts": [["\u0418\u043c\u044f", "\u0420\u043e\u043b\u044c", "\u041f\u043e\u0447\u0442\u0430", "\u0422\u0435\u043b\u0435\u0444\u043e\u043d"],
    ...
    "tr": {
        ...
        "invoice": ["Fatura 2026-014", "12 Haziran 2026 tarihli", "30 g\u00fcn i\u00e7inde \u00f6denir", "Fatura edilen", "Ara toplam", "KDV %20", "\xd6denecek tutar", "\u0130\u015f birli\u011finiz i\xe7in te\u015fekk\xfcrler.", "Adet", "Birim fiyat"],
        "contacts": [["Ad", "G\u00f6rev", "E-posta", "Telefon"],

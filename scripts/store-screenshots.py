...
#
#   scripts/store-screenshots.py --languages          what to capture
#   scripts/store-screenshots.py                      check what was captured
#   scripts/store-screenshots.py --stage DIR          check it and stage it
#
